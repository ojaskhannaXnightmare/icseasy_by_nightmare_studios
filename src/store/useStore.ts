...
export type PageType = 'landing' | 'login' | 'signup' | 'dashboard' | 'tutor' | 'subjects' | 'subject-detail' | 'notes' | 'research' | 'quiz-setup' | 'quiz-active' | 'quiz-results' | 'friends' | 'messages' | 'groups' | 'profile' | 'group-chat' | 'timer' | 'leaderboard'
